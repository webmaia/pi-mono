...
import type { AssistantMessage, ImageContent, Message, Model, TextContent, UserMessage } from "@earendil-works/pi-ai";
import {
	clampThinkingLevel,
...
export class AgentSession {
	 ...
	 * Expands skill commands and prompt templates. Errors on extension commands.
	 * @param options Image attachments and/or messageId (or legacy ImageContent[])
	 * @throws Error if text is an extension command
	 */
